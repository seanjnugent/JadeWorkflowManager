# Generated by workflow API on 2025-05-14T20:39:47.687974
                ...
                with context.resources.db_engine.connect() as conn:
                    conn.execute(
                        text('INSERT INTO workflow.run_log (dagster_run_id, workflow_id, step_id, log_level, message, timestamp) VALUES (:run_id, :workflow_id, :step_id, \'info\', :message, NOW())'),
                        {
                            ...
                            "step_id": "load_input_csv_to_api_21",
            ...
            with context.resources.db_engine.connect() as conn:
                conn.execute(
                    text('INSERT INTO workflow.run_log (dagster_run_id, workflow_id, step_id, log_level, message, timestamp) VALUES (:run_id, :workflow_id, :step_id, \'info\', :message, NOW())'),
                    {
                        "run_id": context.run_id,
                        "workflow_id": workflow_id,
                        "step_id": "transform_csv_to_api_21",
...
@op(
    ...
    name="save_output_csv_to_api_21"
)
                ...
                with context.resources.db_engine.connect() as conn:
                    ...
                    conn.execute(
                        text('INSERT INTO workflow.run_log (dagster_run_id, workflow_id, step_id, log_level, message, timestamp) VALUES (:run_id, :workflow_id, :step_id, \'info\', :message, NOW())'),
                        {
                            "run_id": context.run_id,
                            "workflow_id": workflow_id,
                            "step_id": "save_output_csv_to_api_21",
...
@job(
    ...
    tags={
        "workflow_id": "21",
        "workflow_name": "csv_to_api",
        "generated_at": "2025-05-14T20:39:47.687974",
        "dag_filename": "csv_to_api_job_21.py"
    }
)
def workflow_job():
