...
@op(
    ...
    name="load_input_workflow_job_59"
)
...
@op(
    ...
    name="transform_workflow_job_59"
)
...
@op(
    ...
    name="save_output_workflow_job_59"
)
...
@job(
    ...
    config={
        "ops": {
            ...
            "transform_workflow_job_59": {
                "config": {
                    "workflow_id": 59,
                    "parameters": {}
                }
            },
            "save_output_workflow_job_59": {
                "config": {
                    "output_file_path": "",
                    "workflow_id": 59
                }
    ...
    tags={
        "workflow_id": "59",
        "workflow_name": "push_to_ckan",
        "generated_at": "2025-05-23T14:30:23.381962",
        "dag_filename": "workflow_job_59.py"
    }
)
def workflow_job():
