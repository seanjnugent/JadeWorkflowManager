# Generated by workflow API on 2025-05-14T20:35:54.533431
...
@op(
    ...
    name="load_input_csv_to_json_20"
)
                ...
                with context.resources.db_engine.connect() as conn:
                    conn.execute(
                        text('INSERT INTO workflow.run_log (dagster_run_id, workflow_id, step_id, log_level, message, timestamp) VALUES (:run_id, :workflow_id, :step_id, \'info\', :message, NOW())'),
                        {
                            ...
                            "step_id": "load_input_csv_to_json_20",
            ...
            with context.resources.db_engine.connect() as conn:
                conn.execute(
                    text('INSERT INTO workflow.run_log (dagster_run_id, workflow_id, step_id, log_level, message, timestamp) VALUES (:run_id, :workflow_id, :step_id, \'info\', :message, NOW())'),
                    {
                        "run_id": context.run_id,
                        "workflow_id": workflow_id,
                        "step_id": "transform_csv_to_json_20",
...
@op(
    ...
    name="save_output_csv_to_json_20"
)
                ...
                with context.resources.db_engine.connect() as conn:
                    ...
                    conn.execute(
                        text('INSERT INTO workflow.run_log (dagster_run_id, workflow_id, step_id, log_level, message, timestamp) VALUES (:run_id, :workflow_id, :step_id, \'info\', :message, NOW())'),
                        {
                            "run_id": context.run_id,
                            "workflow_id": workflow_id,
                            "step_id": "save_output_csv_to_json_20",
...
@job(
    ...
    tags={
        "workflow_id": "20",
        "workflow_name": "csv_to_json",
        "generated_at": "2025-05-14T20:35:54.533431",
        "dag_filename": "csv_to_json_job_20.py"
    }
)
def workflow_job():
