# Generated by workflow API on 2025-05-14T19:44:14.923469
...
@op(
    ...
    name="load_input_test_again_new_may_24"
)
                ...
                with context.resources.db_engine.connect() as conn:
                    conn.execute(
                        text('INSERT INTO workflow.run_log (dagster_run_id, workflow_id, step_id, log_level, message, timestamp) VALUES (:run_id, :workflow_id, :step_id, \'info\', :message, NOW())'),
                        {
                            ...
                            "step_id": "load_input_test_again_new_may_24",
...
@op(
    ...
    name="transform_test_again_new_may_24"
)
            ...
            with context.resources.db_engine.connect() as conn:
                conn.execute(
                    text('INSERT INTO workflow.run_log (dagster_run_id, workflow_id, step_id, log_level, message, timestamp) VALUES (:run_id, :workflow_id, :step_id, \'info\', :message, NOW())'),
                    {
                        "run_id": context.run_id,
                        "workflow_id": workflow_id,
                        "step_id": "transform_test_again_new_may_24",
...
@op(
    ...
    name="save_output_test_again_new_may_24"
)
                ...
                with context.resources.db_engine.connect() as conn:
                    ...
                    conn.execute(
                        text('INSERT INTO workflow.run_log (dagster_run_id, workflow_id, step_id, log_level, message, timestamp) VALUES (:run_id, :workflow_id, :step_id, \'info\', :message, NOW())'),
                        {
                            "run_id": context.run_id,
                            "workflow_id": workflow_id,
                            "step_id": "save_output_test_again_new_may_24",
...
@job(
    name="test_again_new_may_job_24",
    resource_defs={
    ...
    config={
        "ops": {
            "load_input_test_again_new_may_24": {
                "config": {
            ...
            "transform_test_again_new_may_24": {
                "config": {
                    "workflow_id": 24,
                    "parameters": {} # These could be populated from workflow config
                }
            },
            "save_output_test_again_new_may_24": {
                "config": {
                    "output_file_path": "workflow-files/outputs/{{ run_id }}.json",
                    "workflow_id": 24
                }
    ...
    tags={
        "workflow_id": "24",
        "workflow_name": "test_again_new_may",
        "generated_at": "2025-05-14T19:44:14.923469",
        "dag_filename": "test_again_new_may_job_24.py"
    }
)
def workflow_job():
