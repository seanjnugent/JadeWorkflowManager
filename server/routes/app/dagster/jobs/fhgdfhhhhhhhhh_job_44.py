# Generated by workflow API on 2025-05-16T16:57:41.754287
...
@op(
    ...
    name="load_input_fhgdfhhhhhhhhh_44"
)
                ...
                with context.resources.db_engine.connect() as conn:
                    conn.execute(
                        text('INSERT INTO workflow.run_log (dagster_run_id, workflow_id, step_id, log_level, message, timestamp) VALUES (:run_id, :workflow_id, :step_id, \'info\', :message, NOW())'),
                        {
                            ...
                            "step_id": "load_input_fhgdfhhhhhhhhh_44",
...
@op(
    ...
    name="transform_fhgdfhhhhhhhhh_44"
)
            ...
            with context.resources.db_engine.connect() as conn:
                conn.execute(
                    text('INSERT INTO workflow.run_log (dagster_run_id, workflow_id, step_id, log_level, message, timestamp) VALUES (:run_id, :workflow_id, :step_id, \'info\', :message, NOW())'),
                    {
                        "run_id": context.run_id,
                        "workflow_id": workflow_id,
                        "step_id": "transform_fhgdfhhhhhhhhh_44",
...
@op(
    ...
    name="save_output_fhgdfhhhhhhhhh_44"
)
                ...
                with context.resources.db_engine.connect() as conn:
                    ...
                    conn.execute(
                        text('INSERT INTO workflow.run_log (dagster_run_id, workflow_id, step_id, log_level, message, timestamp) VALUES (:run_id, :workflow_id, :step_id, \'info\', :message, NOW())'),
                        {
                            "run_id": context.run_id,
                            "workflow_id": workflow_id,
                            "step_id": "save_output_fhgdfhhhhhhhhh_44",
...
@job(
    ...
    config={
        "ops": {
            ...
            "transform_fhgdfhhhhhhhhh_44": {
                "config": {
                    "workflow_id": 44,
                    "parameters": {} # These could be populated from workflow config
                }
            },
            "save_output_fhgdfhhhhhhhhh_44": {
                "config": {
                    "output_file_path": "workflow-files/outputs/{{ run_id }}.json",
                    "workflow_id": 44
                }
    ...
    tags={
        "workflow_id": "44",
        "workflow_name": "fhgdfhhhhhhhhh",
        "generated_at": "2025-05-16T16:57:41.754287",
        "dag_filename": "fhgdfhhhhhhhhh_job_44.py"
    }
)
def workflow_job():
