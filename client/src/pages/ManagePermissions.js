...
const ManagePermissions = () => {
  ...
  const DestinationIcon = ({ destination }) => {
    switch (destination?.toLowerCase()) {
      ...
      case 'csv': return <Database className="w-4 h-4 text-green-600" />;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              ...
              <h1 className="text-2xl font-bold text-gray-900">Workflow Permissions</h1>
            </div>
          </div>
        </div>
      </div>
                            ...
                            <div key={perm.id} className="flex items-center justify-between p-2 bg-gray-50 rounded-lg">
                              <div className="flex items-center">
                                ...
                                <div className="ml-3">
                                  ...
                                  <p className="text-xs text-gray-500 capitalize">{perm.permission_level} access</p>
                                </div>
                              </div>
                              <button
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-6">
                ...
                <h3 className="font-medium text-gray-900">{modalWorkflow?.name}</h3>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-2 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 text-white rounded-lg transition-colors font-medium"
                >
                  Grant Access
                </button>
              </div>
